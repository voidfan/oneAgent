...
RUNNER = r"""import React, { useEffect, useState, useRef, useCallback } from 'react';
...
path = os.path.join(os.path.dirname(__file__), 'frontend', 'src', 'pages', 'WorkflowRunnerPage.js')
with open(path, 'w', encoding='utf-8') as f:
    f.write(RUNNER)
print(f"Written {len(RUNNER)} chars to {path}")
